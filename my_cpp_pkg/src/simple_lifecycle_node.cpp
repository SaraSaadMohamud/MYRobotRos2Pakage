...
{
    public:
    explicit SimpleLifeCycle(const std::string &node_name ,bool intra_process_comms = false) 
    ...
    rclcpp_lifecycle::node_interfaces::LifecycleNodeInterface::CallbackReturn on_configure(const rclcpp_lifecycle::State &)
    {
        ...
        RCLCPP_INFO(get_logger(),"Lifecycle node on_configured() called");
    ...
    {
        sub_ .reset();
        RCLCPP_INFO(get_logger(),"Lifecycle node on_breakup() called");
        return(rclcpp_lifecycle::node_interfaces::LifecycleNodeInterface::CallbackReturn::SUCCESS);
    }
...
int main(int argc, char *argv[])
{
    ...
    std::shared_ptr<SimpleLifeCycle> simple_lifecycle_node = std::make_shared<SimpleLifeCycle>("simple_lifecycle_node");
